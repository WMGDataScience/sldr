...
exp_args=['--env_id', env_name,
          '--exp_id', model_name + '_dgx1_foo160_' + str(0),
          '--random_seed', str(0), 
...
exp_args2=['--env_id', env_name,
          '--exp_id', model_name + '_dgx1_foo161_' + str(0),
          '--random_seed', str(0), 
          '--agent_alg', model_name,
          '--verbose', '2',
          '--render', '0',
...
path = './models/recent/rob_model_PnP_v4_Norm_Slide_Clipped_Both_Masked_PlusR/'
...
np.save('./monitors/recent/monitor_FetchPickandPlaceMulti-v1_Rew_v4_Norm_Slide_Clipped_Both_Masked_PlusR.npy', monitor2)
