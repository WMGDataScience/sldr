...
if exp_config['env'] == 'EggRotate':
    env_name = 'HandManipulateEggRotateMulti-v0'
elif exp_config['env'] == 'EggFull':
    env_name = 'HandManipulateEggFullMulti-v0'
elif exp_config['env'] == 'PenRotate':
    env_name = 'HandManipulatePenRotateMulti-v0'
elif exp_config['env'] == 'PenFull':
    env_name = 'HandManipulatePenFullMulti-v0'
elif exp_config['env'] == 'BoxRotate':
    env_name = 'HandManipulateBlockRotateXYZMulti-v0'
elif exp_config['env'] == 'BoxFull':
    env_name = 'HandManipulateBlockFullMulti-v0'
